export const appointmentCancelledTemplate = (appointment) => {
  return `
 <style>
...
<div class="email-container"
  ...
  <h2 class="header-title"
    style="color: #dc2626; text-align: center; margin-top: 15px; padding-bottom: 15px; ">
    Appointment Cancelled
  </h2>

  <div style="color: #374151; font-size: 16px; line-height: 1.6;">
   <p>Hello  <span style="font-weight: 600; font-size: 18px; color: #111827;">${appointment.userData.name}</span>,</p>
    <p>Your appointment has been cancelled. Below are the details of the cancelled booking for your reference:</p>
  </div>
  ...
  <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 20px; margin: 25px 0;">
    <p class="detail-row" style="margin: 10px 0; color: #1e293b; font-size: 15px;">
      <strong class="detail-label" style="color: #7f1d1d; display: inline-block; width: 140px;">Doctor:</strong>
      ${appointment.doctorData?.name}
    </p>
    <p class="detail-row" style="margin: 10px 0; color: #1e293b; font-size: 15px;">
      <strong class="detail-label" style="color: #7f1d1d; display: inline-block; width: 140px;">Date:</strong>
      ${appointment.slotDate}
    </p>
    <p class="detail-row" style="margin: 10px 0; color: #1e293b; font-size: 15px;">
      <strong class="detail-label" style="color: #7f1d1d; display: inline-block; width: 140px;">Time:</strong>
